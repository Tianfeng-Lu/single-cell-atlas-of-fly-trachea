...
# normalized_counts <- counts(analyseddata, normalized=TRUE)  #       counts
colnames(normalized_counts) 
colnames(normalized_counts) <- c("L3","L3","L3","L3","0h","0h","0h","0h","2h","2h","2h","2h") # analysis data         
...
new_enrich@result <- new_enrich@result[c("GO:0045216","GO:0051130","GO:0006486","GO:0043413","GO:0032970","GO:0070085","GO:0022604","GO:0090130"),]%>% arrange(desc(Count)) #        
...
set.seed(17) #   
cl <- mfuzz(seset, 6, mestimate(eset)) #          ，         fuzzification parameter.
