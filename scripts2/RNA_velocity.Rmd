...
## functionset
```{r}
## barcode, ，CAD_mergebarcode,nloomfileCAD_merge
...
```{r}
#，umap，
## barcode, ，CAD_mergebarcode,nloomfileCAD_merge, aggregation.csv
...
EC_cells <- surfix_mapper(colnames(CAD_ECs), colnames(merge_velo)) # CAD_ECscell id
